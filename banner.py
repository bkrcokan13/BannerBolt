...
class Banner:
            ...
            for pageCount in range(1, (2 + 1), 1):
                ...
                for divs in productsDiv:
                    ...
                    for href in hrefs:
                        ...
                        cleanedHref = str(href.get("href")).replace('\u00a3', '£')
                        self._advertlist[categories_name].append(str(self._base_url + cleanedHref))
    ...
    def extract_data(self):
        ...
        try:
            ...
            file_name = f"{file_create_time}.json"

            json_data = json.dumps(self._advertlist, indent=4)

            with open(file_name, 'w') as jsonFile:
                jsonFile.write(json_data)

            print(f"[{file_create_time}]:{file_name} is extracted.")
